  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:system-ui,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
        <div style="font-size:24px;font-weight:700;margin-bottom:8px">Rent Kar Ghar</div>
        <div style="font-size:14px;color:#666;margin-bottom:32px">Pakistan&apos;s verified rental marketplace</div>
